...
<h3><spring:message code="label.incomingReport"/></h3>
<label></label>
<form action="${pageContext.request.contextPath}/viewIncomingReport" method="post" target="_blank" modelAttribute="reportParameter">
<!-- <form action="/Inventory/viewIncomingReportHtml" method="get" > -->
	<%-- <p>
	...
	<p>
		<label></label><input type="submit" id="show" value="<spring:message code="label.viewIncomingReport"/>">
	</p>
</form>
