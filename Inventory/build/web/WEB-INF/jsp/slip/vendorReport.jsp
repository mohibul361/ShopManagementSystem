...
<form:form action="${pageContext.request.contextPath}/viewVLedger" method="POST"  id="submitVLForm" modelAttribute="reportParameterVL" target="_blank">
	<p>
...
<form:form action="${pageContext.request.contextPath}/viewVBalance" method="POST"  id="submitVBForm" modelAttribute="reportParameterVB" target="_blank">	
	<p>
